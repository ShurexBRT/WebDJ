...
export const AUTO_DJ_MIX_PROFILES: Record<AutoDjMixProfileId, AutoDjMixProfile> = {
  smooth: {
    ...
    transitionBeats: { 'long-blend': 128, 'bass-swap': 64, 'filter-blend': 64, 'echo-out': 8, 'hard-cut': 4 },
  },
  club: {
    id: 'club',
    label: 'Club Energy',
    ...
    transitionBeats: { 'long-blend': 64, 'bass-swap': 32, 'filter-blend': 32, 'echo-out': 8, 'hard-cut': 4 },
  },
  deep: {
    id: 'deep',
    label: 'Deep / Melodic',
    ...
    transitionBeats: { 'long-blend': 64, 'bass-swap': 64, 'filter-blend': 64, 'echo-out': 8, 'hard-cut': 4 },
  },
  quick: {
    id: 'quick',
    label: 'Quick Cut',
